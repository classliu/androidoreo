...
package com.classliu.androidoreo.tab;
...
import com.classliu.androidoreo.R;
import com.classliu.androidoreo.widget.MovieView;
...
public class PictureInPictureActivity extends AppCompatActivity {
    ...
    void updatePictureInPictureActions(@DrawableRes int iconId, String title, int controlType,
        ...
        // be properly updated.
        final PendingIntent intent = PendingIntent.getBroadcast(PictureInPictureActivity.this,
        ...
        actions.add(new RemoteAction(
                ...
                PendingIntent.getActivity(PictureInPictureActivity.this, REQUEST_INFO,
